...
public class StringUtils {
    public static final String WELCOME_MESSAGE = "------Welcome to J Shopping------";
    ...
    public static final String EMPTY_CART = "Your is Empty!!!";
    public static final String CART = "YOur Cart";
    public static final String TOTAL_PRICE = "Total Price - Rs. ";
    public static final String PLACE_ORDER = "Successfully Order placed!!! ";
    public static final String PRINT_CHECKOUT = "77. Checkout";
    public static final String PRODUCT_MENU = "Products";
    public static final String CART_SUCCESS = " Product add successfully!!!";
}